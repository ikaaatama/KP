...
<input type="hidden" name="id" value="{{ $p->id }}">
    ...
    <div class="row">
        <div class="form-group col-sm-12">
            ...
            <input type="text" name="alamat_surat" value="{{ $p->alamat_surat}}" class="form-control @error('alamat_surat') is-invalid @enderror" required autocomplete="asal_surat" autofocus>
            @error('alamat_surat')
                <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
                </span>
